...
class SQL:
	def __init__(self):
		self.Connection = MySQLdb.connect("localhost", "root", "", "log")
...
'''
mysql> desc log;
create table log ( m_checksum varchar(100), checksum varchar(40), filename varchar(100), dedup varchar(100), username varchar(100), count int(11));
+----------+--------------+------+-----+---------+-------+
...
create table 256kb_chunks( m_checksum varchar(100), c_checksum varchar(100), seq_no int(50));
+------------+--------------+------+-----+---------+-------+
| Field      | Type         | Null | Key | Default | Extra |
+------------+--------------+------+-----+---------+-------+
| m_checksum | varchar(100) | YES  |     | NULL    |       |
| c_checksum | varchar(100) | YES  |     | NULL    |       |
| seq_no     | int          | YES  |     | NULL    |       |
+------------+--------------+------+-----+---------+-------+
